class ConversationEntity {
  ...
  static ConversationEntity fromMap(Map<String, Object?> map) => ConversationEntity(
        id: map['id'] as int?,
...
class MessageEntity {
  ...
  MessageEntity({this.id, required this.conversationId, required this.text, required this.isUser, required this.createdAt});
